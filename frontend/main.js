var imageUpload, imageUploadTop, imageDisplay,
    imageInput, urlInput, fileInput,
    imageDisplayArea, fileDropArea, buttonArea, loadingArea,
    sendButton, sendAnotherButton, imageSendButton, openFileButton,
    embedSection, lyricsText, embedTemplate;
...
function searchTrack(searchOption) {
    if (currUrl !== null || currImage !== null) {
        ...
        if (currUrl !== null) {
            ...
            requestPromise = postRequest(apiUrl + searchOption, params);
        }
